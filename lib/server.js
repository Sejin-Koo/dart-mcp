...
export function buildServer() {
  ...
  server.tool(
    ...
    "공시서류 원본파일(document.xml) 조회 — 사업의 내용, 정관상 사업목적과 영위 여부, " +
      ...
      "30~40초가 걸립니다(정상 동작이며 실패가 아님). 찾는 내용이 사업보고서의 " +
      "\"II. 사업의 내용\"(사업의 개요/주요 제품 및 서비스/원재료 및 생산설비/매출 및 " +
      "수주상황/주요계약 및 연구개발활동/기타 참고사항) 범위에 해당한다면, 이 서버 밖에 " +
      "해당 섹션만 즉시 반환하는 도구가 연결되어 있는 환경도 있습니다 — 사용 가능한 도구 " +
      "목록을 먼저 확인해 그런 도구가 있으면 그쪽을 우선 사용하고, 없으면 이 도구를 " +
      "그대로 쓰면 됩니다. 단 재무제표 주석에 해당하는 내용(위험관리·공정가치·전환사채 " +
      "잔액 등)은 정확도가 중요하므로 그런 대체 경로가 있더라도 이 도구로 원문을 확인하세요.",
    {
